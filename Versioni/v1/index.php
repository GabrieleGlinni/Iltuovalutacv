    ...
    <div>
        <span class="d-block p-2 bg-primary text-white"
            style="text-align: center; font-size: large; position: relative"><span style="text-align: center; padding-left: 10%">Quanto funziona bene il tuo CV?
                Ottieni gratuitamente un resoconto da un esperto! </span><span style="float: right; padding-right:1%; font-size: medium"><a href="Login.php" style ="color: white"> Login</a> • <a href="Register.php" style="color: white">Registrati</a></span>
        </span>
        ...
        <div style="position: absolute; top: 40%; left: 50%; margin-top: -50px; margin-left: -50px; height: 200px;">
            <form method="post" enctype="multipart/form-data">
                <input type="file" name="file"></input>
                <br>
                <br>
                <input type="submit" name="submit" class="btn btn-outline-primary"></input>
        </div>
...
//        {
//            // MAIL AUTOMATICA
//            // Indirizzo dove mandare la mail
//            $to = 'gabrieleglinni@gmail.com';
//            //Soggetto dell'email
//            $subject = "Puoi valutare il mio cv?";
//            //messaggio inviato all'email
//            $message = 'Puoi valutare il mio cv? Grazie!';
//            //Headers dell'email
